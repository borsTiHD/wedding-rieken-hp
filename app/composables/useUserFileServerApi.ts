...
export default function useUserFileServerApi() {
  ...
  async function getAllFiles(filePath: string, limit?: number): Promise<ImageFile[]> {
    ...
    // do {
    //   const response = await $fetch(`${apiBaseUrl}/user/files`, {
    //     method: 'GET',
    ...
    //   // Transform response.files to match ImageFile type
    //   const transformedFiles = response.files.map((file: SerializeObject<ImageFile>) => ({
    //     ...file,
    //     metadata: {
    //       ...file.metadata,
  ...
  async function downloadFile(fileId: string) {
    ...
    try {
      ...
      const response = await $fetch.raw(`${apiBaseUrl}/user/download`, {
        method: 'GET',
        params: { path: fileId },
  ...
  async function downloadFolder(folderPath: string) {
    ...
    try {
      ...
      const response = await $fetch.raw(`${apiBaseUrl}/user/download/folder`, {
        method: 'GET',
