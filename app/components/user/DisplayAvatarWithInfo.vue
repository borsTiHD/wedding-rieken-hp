      ...
      <div class="flex items-center gap-4">
        <div class="flex items-center">
          ...
          <div class="ml-3">
            ...
            <h1 class="text-2xl font-semibold text-gray-700 hidden md:inline">
              {{ displayName ? t('user.welcome', { name: displayName }) : t('user.noName') }}
            </h1>
            <h1 class="text-lg font-semibold text-gray-700 inline md:hidden">
