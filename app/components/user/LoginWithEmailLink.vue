...
// Submit button
async function handleSubmit(form: { email: string }) {
  loading.value = true
...
<template>
  ...
  <InlineMessage v-else-if="checkEmail" severity="success">
    {{ t('login.loginWithMailSend') }}
  </InlineMessage>
  ...
  >
    <div class="flex flex-col">
      <p class="mb-4 font-medium">
        {{ t('login.loginHintWithoutPassword') }}
      </p>
