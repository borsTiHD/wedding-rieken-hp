...
// Submit handler
async function handleSubmit(form: { fileName: string, fileExtension: string }) {
...
function show(options: { title?: string, message?: string, okButton?: string, cancelButton?: string, persistent?: boolean, formKitSchema?: FormKitSchemaNode[], formKitLibrary?: undefined }) {
  // Set form options
...
<template>
  <Dialog
    ...
    :dismissable-mask="!formOptions.persistent"
