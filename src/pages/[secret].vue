                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative inline-block">
                            <ShowUnderline color="text-purple-400">
                                <h1 class="font-great-vibes text-4xl md:text-6xl drop-shadow-sm">{{ t('ghostGame.header') }}</h1>
                            </ShowUnderline>
                        </div>
                    </div>
                </template>
                <template #content>
                    <p class="text-center">{{ t('ghostGame.secret') }}</p>
                </template>
            </Card>
            ...
            <Card :pt="{ title: 'mb-4' }">
                <template #title>
                    <div class="flex flex-col items-center">
                        <div class="relative inline-block">
                            <ShowUnderline color="text-purple-400">
                                <h1 class="font-great-vibes text-4xl md:text-6xl drop-shadow-sm">{{ t('general.404') }}</h1>
                            </ShowUnderline>
                        </div>
                    </div>
                </template>
                <template #content>
                    <p class="text-center">{{ t('ghostGame.secretWrong') }}</p>
                </template>
            </Card>
            <ShowRiddle />
        </template>
